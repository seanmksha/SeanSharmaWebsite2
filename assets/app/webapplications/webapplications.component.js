...
var WebApplicationsComponent = /** @class */ (function () {
    function WebApplicationsComponent() {
        ...
        this.mainParagraph = "Web applications using HTML, CSS, Javascript, NodeJS, Express, Angular, React-Redux, MongoDB, SQL, and/or PHP.";
        ...
        this.messageBoardText = "An application that allows authenticated users to post on a community message board.";
        ...
        this.newsWatcherText = "An application where users can pick filters and get filtered news updates from the New York Times.";

...
var ProjectsComponent = /** @class */ (function () {
    function ProjectsComponent() {
        ...
        this.mainParagraph = "Gaming or technical projects created by Sean Sharma or a group that Sean Sharma participated in";
        ...
        this.imageCompressorText = "An application that has email verification for newly registered users with authentication and acts as a simple message board";
        ...
        this.stockMarketText = "An android application version of the stock market website";
